...
import 'package:day3/User_Side/click_hospital_screen/Contact_Hospital/Contact_Hospital.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      //theme: ThemeData(
        ...
        //useMaterial3: true,
     // ),
      home: ContactHospital()//clickhospital()//AddScreen()//DashboardScreen()//VerificationScreen()//OtpScreen()//RegisterScreen()//LoginScreen()//SplashScreen()//const MyHomePage(title: 'Flutter Demo Home Page'),
    );
  }
}
